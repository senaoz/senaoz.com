export const projects = [
  ...
  },
  {
    ...
    description:
      "Developed an NLP-based academic publication recommendation system as a Graduate Research Project at Boğaziçi University. The system monitors followed institutions for newly published papers and matches them against a corpus of Boğaziçi University researchers using a two-stage retrieval and LLM-based reranking pipeline. Built research datasets from 4,608 BOUN papers and 9,946 papers from followed institutions, and benchmarked 9 retrieval and ranking methods including TF-IDF, BM25, MiniLM, SPECTER2, Qwen, embeddinggemma, and Llama-based reranking using Hit Rate, MRR, nDCG, and Top-1 accuracy. The Llama 3.2 3B reranker achieved 44.99% Hit Rate, 0.841 MRR, 0.838 nDCG, and 75% Top-1 accuracy, substantially outperforming the evaluated embedding-based approaches. Extended the research pipeline into a production-oriented recommendation system using OpenAlex, FastAPI, PostgreSQL/pgvector, Ollama, React, and TypeScript.",
  },
  {
